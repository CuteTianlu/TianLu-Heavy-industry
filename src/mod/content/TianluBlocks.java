...
public class TianluBlocks {
    public static Block //注册方块
        ...
        Thermal_Transmission_Line,//热力线路
        IronCurtain,//铁幕装置
        IronBlock;//铁
    public static void load(){//建筑
        ...
        Electric_Heating_Machine = new HeatProducer("电制热机"){{
            requirements(crafting, with(Copper_lead_alloy, 25, titanium, 18));
            health = 50;
        ...
        Copper_Lead_Alloy_Conveyor = new Conveyor("铜铅合金传送带") {{
            requirements(distribution, with(Copper_lead_alloy, 1));
            health = 32;
            speed = 0.045f;
            displayedSpeed = 6.5f;
            researchCost = with(Copper_lead_alloy, 35);
        }};
        //运输-热力
        Thermal_Transmission_Line = new HeatConductor("热力线路") {{
            requirements(crafting, with(Copper_lead_alloy, 1));
            health = 32;
            size = 1;
        }};
        //辅助
