...
public class TianluNatural_StarPlanetGenerator extends BlankPlanetGenerator {
    ...
    public float thoriumScl = 1f, copperScale = 1f, leadScale = 1f, ironScale = 1f;
    ...
    public void generate(){
        seed = TianluPlanets.Natural_Star.sectorSeed;
        ...
        ore(Blocks.oreCopper, Blocks.stone, 5f, 0.8f * copperScale);
        ...
        oreAround(TianluBlocks.iron, Blocks.ferricStone, 3, 70f, 0.6f * ironScale);
        ore(TianluBlocks.iron, TianluBlocks.iron, 4f, 0.9f * ironScale);
