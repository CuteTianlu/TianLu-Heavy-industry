...
public class TianluNatural_StarPlanetGenerator extends PlanetGenerator{
    ...
    {
        defaultLoadout = Schematics.readBase64("bXNjaAF4nGNgZmBmYWDJS8xNZeB5sX/msxnrny3Y8XR/MwNXcn5eSWpeiW9iAQNTdS0Dd0pqcXJRZkFJZn4eg8PLGfufbt8CIbmezel8smvXkz2znvZPfN634emE6RDGk11tTyd2vVjf+axjYmDg+z2zjE3NjMxMTEwNjRnYchKTUnOKGZiiYxkZZIwMDI0MzIyMSzIT83JKdZ1S0zPz8lKL4p3zi1IZGBgYQQhIAAAkHEih");
    }
    ...
    protected void generate() {
        ...
        pass((x, y) -> {
            if(!nearWall(x, y)){
                //矿物生成部分
                if(noise(x + 999, y + 999 - x, 4, 0.61f, 45f, 1f) < 0.27f && floor == Blocks.stone){
                    ore = TianluBlocks.iron;
                }
            }
        });
        ...
        pass((x, y) -> {
            if(floor == stone || Ridged.noise2d(seed + 1, x, y, 4, 0.7f, 1f / 60f) > 0.45f || Mathf.within(x, y, sx, sy, 20 + Ridged.noise2d(seed, x, y, 3, 0.5f, 1f / 30f) * 6f)) return;
